...
#ifndef CGAL_TRIANGULATION_EUCLIDEAN_TRAITS_3_H
#define CGAL_TRIANGULATION_EUCLIDEAN_TRAITS_3_H


template < class R >
class CGAL_Triangulation_euclidean_traits_3 {
public:
    typedef R Rep;
    ...
    public:
        Distance(const Point& p0,
                 const CGAL_Triangulation_euclidean_traits_3<R>* traits = NULL)
            : _p0(p0)
        {
            CGAL_kernel_assertion( traits == traits ); // avoids warning
        }
...
#endif // CGAL_TRIANGULATION_EUCLIDEAN_TRAITS_3_H
