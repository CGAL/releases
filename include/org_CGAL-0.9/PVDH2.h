...
template < class FT, class RT >
ostream &operator<<(ostream &os, const CGAL_PointH2<FT,RT> &p)
{
...
template < class FT, class RT >
istream &operator>>(istream &is, CGAL_PointH2<FT,RT> &p)
{
    RT hx, hy, hw;
...
template < class FT, class RT >
ostream &operator<<(ostream &os, const CGAL_VectorH2<FT,RT> &p)
{
    switch(os.iword(CGAL_IO::mode)) {
    case CGAL_IO::ASCII :
        return os << p.hx() << ' ' << p.hy() << ' ' << p.hw();
...
template < class FT, class RT >
istream &operator>>(istream &is, CGAL_VectorH2<FT,RT> &p)
{
    RT hx, hy, hw;
    switch(is.iword(CGAL_IO::mode)) {
    case CGAL_IO::ASCII :
...
template < class FT, class RT >
ostream &operator<<(ostream &os, const CGAL_DirectionH2<FT,RT> &p)
{
    switch(os.iword(CGAL_IO::mode)) {
    case CGAL_IO::ASCII :
        return os << p.dx() << ' ' << p.dy();
...
template < class FT, class RT >
istream &operator>>(istream &is, CGAL_DirectionH2<FT,RT> &p)
{
    RT x, y;
    switch(is.iword(CGAL_IO::mode)) {
    case CGAL_IO::ASCII :
