...
/* syntax:				
Trapezoidal_map_2<Traits,X_curve_plus> 			*/
template < class Traits,class X_curve_plus> class Trapezoidal_map_2;
...
public:
  ...
  struct Unbounded {};
  typedef Trapezoidal_map_2<Traits,X_curve_plus> Self;
  ...
  */
  ...
  /* syntax:				
     Trapezoidal_map_2<Traits,X_curve_plus>::In_face_iterator */
  ...
  //////////////////////////////////////////////
  //Trapezoidal_map_2 member functions:
  //////////////////////////////////////////////
...
*/
  ...
  */
  ...
  /*==============================================
    Trapezoidal_map_2 public member functions
    ==============================================*/
public:
  
  Trapezoidal_map_2(bool preprocess=false) {init();set_needs_update(preprocess);}
  
  virtual ~Trapezoidal_map_2()
    {
  ...
  X_trapezoid insert_in_face_interior(const X_curve_plus& cv)
    {
      /*
        ...
        std::cout << "\nTM::insert_in_face_interior() begin" << std::endl;
  ...
  void remove_in_face_interior(const X_curve_plus& cv)
    {
      /*
        ...
        std::cout << "\nTM::remove_in_face_interior() begin" << std::endl;
        std::cout << is_valid(*DS);
        std::cout << *DS << std::endl;
  ...
  */
  ...
  /*------------------------------------------------------------------
    ...
    current Trapezoidal_map_2<Traits,X_curve_plus> needs update
    Postconditions:
  ...
  */
  ...
  bool needs_update()
    {
      ...
      */
      return
        depth()>(get_depth_threshold()*(std::log(sz+1)))
  ...
  /*------------------------------------------------------------------
    ...
    bool
    Description:
    uses needs_update to determine whether the Trapezoidal_map_2<Traits,X_curve_plus> needs update
  ...
  */
  ...
  /* ---- output ---------------*/
  friend std::ostream& operator<<(std::ostream &out,const typename Trapezoidal_map_2<Traits,X_curve_plus>::In_face_iterator& it)
    {
...
template < class Traits,class X_curve_plus>
std::ostream& operator<<(std::ostream &out,const Trapezoidal_map_2<Traits,X_curve_plus>& tm)
{
  return out << tm.get_trapezoid_tree()
...
{
  typedef Trapezoidal_map_2<Traits,X_curve_plus> TM;
  typedef __X_trapezoid<Traits, X_curve_plus> X_trapezoid;
  typedef X_trapezoid* pointer;
  out << "(";
...
public:
  ...
  friend class Trapezoidal_map_2<Traits,X_curve_plus>;
  friend class Trapezoidal_map_2<Traits,X_curve_plus>::Around_point_circulator;
  friend class Trapezoidal_map_2<Traits,X_curve_plus>::In_face_iterator;
  typedef DAG< X_trapezoid,TM::Active_right_degenerate_curve_trapezoid > Data_structure;
