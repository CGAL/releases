...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.5-branch/Arrangement_on_surface_2/include/CGAL/Arr_tags.h $
// $Id: Arr_tags.h 50776 2009-07-23 12:12:09Z efif $
// 
//
...
BOOST_MPL_HAS_XXX_TRAIT_DEF(Arr_left_side_tag);
BOOST_MPL_HAS_XXX_TRAIT_DEF(Arr_bottom_side_tag);
...
struct Get_left_side_tag< Traits_, true > {
  typedef typename Traits_::Arr_left_side_tag Tag;
};
...
struct Get_bottom_side_tag< Traits_, true > {
  typedef typename Traits_::Arr_bottom_side_tag Tag;
};
...
public:
  ...
  typedef typename
  Get_bottom_side_tag< Traits, has_Arr_bottom_side_tag< Traits >::value >::Tag 
  Tag;
};
...
struct Get_top_side_tag< Traits_, true > {
  typedef typename Traits_::Arr_top_side_tag Tag;
};
...
struct Get_right_side_tag< Traits_, true > {
  typedef typename Traits_::Arr_right_side_tag Tag;
};
