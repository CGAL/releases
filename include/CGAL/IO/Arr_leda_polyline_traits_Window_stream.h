...
//
// file          : include/CGAL/IO/Arr_leda_polyline_traits_Window_stream.h
...
#ifndef CGAL_ARR_LEDA_POLYLINE_TRAITS_WINDOW_STREAM_H   
#define CGAL_ARR_LEDA_POLYLINE_TRAITS_WINDOW_STREAM_H  
