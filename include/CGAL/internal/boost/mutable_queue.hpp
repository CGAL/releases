...
//=======================================================================
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14-beta1/STL_Extension/include/CGAL/internal/boost/mutable_queue.hpp $
// $Id: mutable_queue.hpp a05b134a %aI Sébastien Loriot
