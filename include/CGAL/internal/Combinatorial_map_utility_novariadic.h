...
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14.2/Combinatorial_map/include/CGAL/internal/Combinatorial_map_utility_novariadic.h $
// $Id: Combinatorial_map_utility_novariadic.h 0698f79 2017-10-20T23:34:14+02:00 Sébastien Loriot
...
struct Conditionnal_run<Functor,n,Void>
{
  ...
  template<class T1,class T2>
  static void run(T1&,T2&){}

  template<class T1,class T2,class T3>
  static void run(T1&,T2&,T3&){}

  template<class T1,class T2,class T3,class T4>
  static void run(T1&,T2&,T3&,T4&){}

  template<class T1,class T2,class T3,class T4,class T5>
  static void run(T1&,T2&,T3&,T4&,T5&){}
...
struct Foreach_static_restricted<Functor,CGAL::cpp11::tuple<>,n>{
  ...
  template<class T1,class T2,class T3,class T4,class T5,class T6>
  static void run(T1&,T2&,T3&,T4&,T5&,T6&){}
