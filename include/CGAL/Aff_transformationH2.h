...
class _Aff_transformationH2;

template <class FT, class RT>
class _Aff_transformation_repH2;

template <class FT, class RT>
Aff_transformationH2<FT,RT>
_general_transformation_composition (
                                   _Aff_transformation_repH2<FT,RT> l,
                                   _Aff_transformation_repH2<FT,RT> r);

template <class FT, class RT>
class _Aff_transformation_rep_baseH2 : public Rep
{
public:

    virtual             ~_Aff_transformation_rep_baseH2(){}
    ...
    virtual  Aff_transformationH2<FT,RT>
                        inverse() const = 0;
    virtual  _Aff_transformation_repH2<FT,RT>
...
template < class FT, class RT >
class _Aff_transformation_repH2 :
                            public _Aff_transformation_rep_baseH2<FT,RT>
{
public:

        _Aff_transformation_repH2()
        {
        }
        _Aff_transformation_repH2(
...
public:
             ...
             _Translation_repH2(const VectorH2<FT,RT> & tv) :
               _tv(tv)
             {
             }
             ~_Translation_repH2()
    ...
    virtual  _Aff_transformation_repH2<FT,RT>
             general_form() const
             {
               return _Aff_transformation_repH2<FT,RT>(
                                _tv.hw(),  RT(0)  ,   _tv.hx(),
                                RT(0)  ,   _tv.hw(),  _tv.hy(),
                                                      _tv.hw() );
             }
...
template < class FT, class RT >
class _Rotation_repH2 : public _Aff_transformation_rep_baseH2<FT,RT>
{
public:
             _Rotation_repH2()
             {
...
template < class FT, class RT >
class _Scaling_repH2 : public _Aff_transformation_rep_baseH2<FT,RT>
{
public:
             _Scaling_repH2()
             {
             }
             _Scaling_repH2(const RT& scaling_numerator,
    ...
    virtual  Aff_transformationH2<FT,RT>
             inverse() const
             {
               return Aff_transformationH2<FT,RT>(SCALING,
                                                        _sf_den, _sf_num);
             }
    virtual  bool
             is_even() const
...
public:
          ...
          Aff_transformationH2(
                                 const Aff_transformationH2<FT,RT>& tbc);
          ...
          Aff_transformationH2(const Scaling,
          ...
          Aff_transformationH2(
                                _Aff_transformation_repH2<FT,RT>* ptr);
#endif // CGAL_CFG_INCOMPLETE_TYPE_BUG_1
    ...
    _Aff_transformation_repH2<FT,RT>
                            general_form() const;
...
//               const Aff_transformationH2<FT,RT>& right_argument );
    ...
    Aff_transformationH2<FT,RT> operator*(
              const Aff_transformationH2<FT,RT>& right_argument ) const;

private:

    _Aff_transformation_rep_baseH2<FT,RT>*
                            ptr() const;
};
...
{
  PTR = new _Aff_transformation_repH2<FT,RT>();
}
...
{
  PTR = new _Translation_repH2<FT,RT>( v );
}
...
{
  PTR = new _Scaling_repH2<FT,RT>( a, b);
}
                           ...
                           const RT& scaling_denominator )
{
  ...
  Aff_transformationH2<FT,RT>
        combination =
        Aff_transformationH2<FT,RT>(TRANSLATION,
                                         scaling.inverse().transform(-v) )
      * scaling
      * Aff_transformationH2<FT,RT>(ROTATION,
...
Aff_transformationH2( const RT& a, const RT& b, const RT& c,
                           const RT& d, const RT& e, const RT& f,
                                                     const RT& g)
{
  PTR = new _Aff_transformation_repH2<FT,RT>( a,   b,   c,
                                                   d,   e,   f,
                                                             g  );
}
...
Aff_transformationH2( const RT& a, const RT& b,
                           const RT& d, const RT& e,
                                                     const RT& g)
{
  PTR = new _Aff_transformation_repH2<FT,RT>( a,   b,   RT(0),
                                                   d,   e,   RT(0),
                                                             g  );
}
...
//template < class FT, class RT >
//Aff_transformationH2<FT,RT>::Aff_transformationH2(
//                               _Aff_transformation_repH2<FT,RT>* rep_ptr)
//{
// PTR = rep_ptr;
//}
...
LineH2<FT,RT>
Aff_transformationH2<FT,RT>::
transform(const LineH2<FT,RT>& l) const
{
...
ptr() const
{
  return (_Aff_transformation_rep_baseH2<FT,RT>*)PTR;
}
