...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/Installation/config/support/test_LEDAWIN.C $
// $Id: test_LEDAWIN.C 30642 2006-04-18 12:42:52Z lsaboret $
// 
//
