...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/Installation/config/support/test_GMP.C $
// $Id: test_GMP.C 30642 2006-04-18 12:42:52Z lsaboret $
// 
//
// Author(s)     : various
