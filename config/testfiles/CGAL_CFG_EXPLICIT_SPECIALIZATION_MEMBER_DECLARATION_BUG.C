...
//
// $Source: /CVSROOT/CGAL/Packages/Configuration/config/testfiles/Attic/CGAL_CFG_EXPLICIT_SPECIALIZATION_MEMBER_DECLARATION_BUG.C,v $
// $Revision: 1.6 $ $Date: 2003/10/21 12:14:46 $
// $Name: CGAL_3_0_1  $
//
// Author(s)     : various
