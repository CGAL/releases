...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/Installation/config/testfiles/CGAL_CFG_MATCHING_BUG_6.C $
// $Id: CGAL_CFG_MATCHING_BUG_6.C 30322 2006-04-14 15:07:17Z lsaboret $
// 
//
