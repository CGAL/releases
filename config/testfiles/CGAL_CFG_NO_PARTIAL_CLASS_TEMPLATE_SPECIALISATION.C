...
//
// $Source: /CVSROOT/CGAL/Packages/Configuration/config/testfiles/CGAL_CFG_NO_PARTIAL_CLASS_TEMPLATE_SPECIALISATION.C,v $
// $Revision: 1.6 $ $Date: 2003/10/21 12:14:50 $
// $Name: CGAL_3_0_1  $
//
// Author(s)     : various
