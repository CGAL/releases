...
//
// $Source: /CVSROOT/CGAL/Packages/Configuration/config/testfiles/CGAL_CFG_NO_TMPL_IN_TMPL_DEPENDING_FUNCTION_PARAM.C,v $
// $Revision: 1.5 $ $Date: 2003/10/21 12:14:51 $
// $Name: CGAL_3_0_1  $
//
// Author(s)     : various
