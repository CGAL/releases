...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/Installation/config/testfiles/CGAL_CFG_NO_STDC_NAMESPACE.C $
// $Id: CGAL_CFG_NO_STDC_NAMESPACE.C 28567 2006-02-16 14:30:13Z lsaboret $
// 
//
// Author(s)     : various
