...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/Installation/config/testfiles/CGAL_CFG_USING_BASE_MEMBER_BUG_3.C $
// $Id: CGAL_CFG_USING_BASE_MEMBER_BUG_3.C 28567 2006-02-16 14:30:13Z lsaboret $
// 
//
