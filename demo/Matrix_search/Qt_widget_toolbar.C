...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/Matrix_search/demo/Matrix_search/Qt_widget_toolbar.C $
// $Id: Qt_widget_toolbar.C 29225 2006-03-09 08:30:35Z afabri $
// 
//
// Author(s)     : Radu Ursu
