...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/Stream_support/demo/Stream_support_LEDA/stream_iterator.C $
// $Id: stream_iterator.C 29807 2006-03-29 14:31:13Z fcacciola $
// 
//
