...
//
// $Source: /CVSROOT/CGAL/Packages/Triangulation_2/demo/Triangulation_2/constrained_delaunay_triangulation_2_layers.h,v $
// $Revision: 1.2.6.1 $ $Date: 2004/12/18 17:15:48 $
// $Name:  $
//
// Author(s)     : Radu Ursu
