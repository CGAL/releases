...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/Convex_hull_2/demo/Convex_hull_2/Qt_widget_move_list_point.C $
// $Id: Qt_widget_move_list_point.C 29341 2006-03-10 11:11:54Z afabri $
// 
//
// Author(s)     : Radu Ursu
