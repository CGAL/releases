...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/Min_ellipse_2/demo/Min_ellipse_2/Qt_widget_move_list_point.C $
// $Id: Qt_widget_move_list_point.C 29228 2006-03-09 08:33:43Z afabri $
// 
//
// Author(s)     : Radu Ursu
