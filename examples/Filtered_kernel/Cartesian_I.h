...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.0.2/Filtered_kernel/examples/Filtered_kernel/Cartesian_I.h $
// $Id: examples/Filtered_kernel/Cartesian_I.h e13ef800cb7 $
