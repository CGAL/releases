...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/CGAL-3.2-branch/QP_solver/examples/QP_solver/integer_qp_solver.C $
// $Id: integer_qp_solver.C 30642 2006-04-18 12:42:52Z lsaboret $
// 
//
