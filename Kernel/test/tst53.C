...
void one_pair(segment_t const & seg, trian_t const & trian)
{
    segment_t iseg;
    point_t point;
    CGAL_Segment_2_Triangle_2_pair<myR> pair(&seg, &trian);
    switch (pair.intersection_type()) {
    case CGAL_Segment_2_Triangle_2_pair<myR>::SEGMENT:
	...
	cout<<'\n';
	break;
    case CGAL_Segment_2_Triangle_2_pair<myR>::POINT:
	cout<<"Point intersection.\n";
	pair.intersection(point);
	print(point);
	cout<<'\n';
	break;
    case CGAL_Segment_2_Triangle_2_pair<myR>::NO:
