...
int main()
{
	...
	if (!cin)
	    return 1;
	ray_t l1(point_t(to_nt(x1), to_nt(y1)), point_t(to_nt(x2), to_nt(y2)));
	CGAL_Bbox_2_Ray_2_pair<myR> pair(&box, &l1);
	switch (pair.intersection_type()) {
	case CGAL_Bbox_2_Ray_2_pair<myR>::NO:
	    cout << "No intersection.\n";
	    break;
	case CGAL_Bbox_2_Ray_2_pair<myR>::SEGMENT: {
	    ...
	    cout<<'\n';
	    break; }
	case CGAL_Bbox_2_Ray_2_pair<myR>::POINT: {
